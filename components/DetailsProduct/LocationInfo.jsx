...
const LocationInfo = ({productCity,productStockName,productDetailsName ,productDetailsType }) => {
    return (
        <>
            ...
            <View style={{ width: '100%', height: 35, flexDirection: 'row', alignItems: 'center', paddingLeft: '30' }}>
                <Text style={{ fontSize: 16, fontWeight: '600' }}>{productDetailsName} </Text>
                <Text style={{ fontSize: 16, color: 'gray' }}> ({productDetailsType} )</Text>
            </View>
        </>
    )
}
